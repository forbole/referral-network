    	...
    	return (
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <span className="label label-primary">Adwords</span>&nbsp;
  						  <span className="label label-primary">Entrepreneurship</span>&nbsp;
                <span className="label label-primary">Programming</span>&nbsp;
                <span className="label label-primary">Lecturing</span>&nbsp;
                <span className="label label-primary">Guitar</span>&nbsp;
                <span className="label label-primary">SEO</span>&nbsp;
                <span className="label label-primary">Digital Marketing</span>
              </div>
					  </div>
				</div>
